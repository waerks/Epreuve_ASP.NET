...
namespace BLL.Entities
{
	public class Emprunt
	{
		...
		// Le constructeur
		public Emprunt(Guid empruntId, int preteurId, int emprunteurId, int jeuId, DateTime dateEmprunt, DateTime? dateRetour, int? evaluationPreteur, int? evaluationEmprunteur)
		{
			EmpruntId = empruntId;
			PreteurId = preteurId;
